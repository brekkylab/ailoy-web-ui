...
const ThreadWelcome: FC = () => {
	const { selectedModel, isModelLoading, modelLoadingProgress } =
			...
			<div className="aui-thread-welcome-center flex w-full flex-grow flex-col items-center justify-center">
				{isModelLoading ? (
					<div className="flex size-full flex-col justify-center px-8">
						<h2 className="text-2xl font-semibold">Initializing Agent...</h2>
						{modelLoadingProgress && (
							<h3 className="text-2xl text-muted-foreground/65">
								{Math.round(
									(100 * modelLoadingProgress.current) /
										modelLoadingProgress.total,
								)}
								%
							</h3>
						)}
